...
import edu.byu.cs.tweeter.client.presenter.pagedPresenter.FeedPresenter;
...
public class FeedFragment extends Fragment implements FeedPresenter.View<Status> {
    ...
    private class FeedHolder extends RecyclerView.ViewHolder {
         ...
         */
        FeedHolder(@NonNull android.view.View itemView) {
            super(itemView);
            ...
            itemView.setOnClickListener(new android.view.View.OnClickListener() {
                ...
                public void onClick(android.view.View view) {
                    feedPresenter.onUserSelected(userAlias.getText().toString());
                }
            });
        }
            ...
            for (String mention : status.getMentions()) {
                ...
                spannableString.setSpan(new ClickableSpan() {
                    ...
                    public void onClick(@NonNull android.view.View widget) {
                        ...
                        feedPresenter.onUserSelected(clickable);
