...
import edu.byu.cs.tweeter.client.presenter.pagedPresenter.FollowersPresenter;
 ...
 */
public class FollowersFragment extends Fragment implements FollowersPresenter.View<User> {
    ...
    public android.view.View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        android.view.View view = inflater.inflate(R.layout.fragment_followers, container, false);
    ...
    private class FollowersHolder extends RecyclerView.ViewHolder {
         ...
         */
        FollowersHolder(@NonNull android.view.View itemView) {
            super(itemView);
            ...
            itemView.setOnClickListener(new android.view.View.OnClickListener() {
                ...
                public void onClick(android.view.View view) {
                    followersPresenter.onUserSelected(userAlias.getText().toString());
                }
            });
        }
    ...
    private class FollowRecyclerViewPaginationScrollListener extends RecyclerView.OnScrollListener {
        ...
        public void onScrolled(@NotNull RecyclerView recyclerView, int dx, int dy) {
            ...
            handler.postDelayed(() -> {
                followersPresenter.onScroll(user);
            }, 0);
        }
    }
