...
import edu.byu.cs.tweeter.client.presenter.pagedPresenter.FollowingPresenter;
 ...
 */
public class FollowingFragment extends Fragment implements FollowingPresenter.View<User> {
    ...
    public android.view.View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        android.view.View view = inflater.inflate(R.layout.fragment_following, container, false);
    ...
    @Override
    public void goToNewUserPage(User user){
    ...
    private class FollowingHolder extends RecyclerView.ViewHolder {
         ...
         */
        FollowingHolder(@NonNull android.view.View itemView) {
            super(itemView);
            ...
            itemView.setOnClickListener(new android.view.View.OnClickListener() {
                ...
                public void onClick(android.view.View view) {
                    followingPresenter.onUserSelected(userAlias.getText().toString());
                }
            });
        }
    ...
    private class FollowRecyclerViewPaginationScrollListener extends RecyclerView.OnScrollListener {
        ...
        public void onScrolled(@NotNull RecyclerView recyclerView, int dx, int dy) {
            ...
            handler.postDelayed(() -> {
                followingPresenter.onScroll(user);
            }, 0);
        }
    }
