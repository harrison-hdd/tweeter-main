 ...
 */
public class StoryFragment extends Fragment implements StoryPresenter.View<Status> {
    ...
    public android.view.View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        android.view.View view = inflater.inflate(R.layout.fragment_story, container, false);
    ...
    private class StoryHolder extends RecyclerView.ViewHolder {
         ...
         */
        StoryHolder(@NonNull android.view.View itemView) {
            super(itemView);
            ...
            itemView.setOnClickListener(new android.view.View.OnClickListener() {
                ...
                public void onClick(android.view.View view) {
                    storyPresenter.onUserSelected(userAlias.getText().toString());
                }
            });
        }
            ...
            for (String mention : status.getMentions()) {
                ClickableSpan span = new ClickableSpan() {
                    ...
                    public void onClick(@NonNull android.view.View widget) {
                        ...
                        storyPresenter.onUserSelected(clickable);
